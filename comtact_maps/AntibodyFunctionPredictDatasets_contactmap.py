...
class AntibodyFunctionPredictDatasets(torch.utils.data.Dataset):
    def __init__(self, vocabs_path_H,vocabs_path_L,data_df,train_mode=True, labeled=True):
        self.df = data_df
    ...
    def get_token_ids(self, row):
        H_tokens, L_tokens = self.trim_input(row['Heavy Sequence second'], row['Light Sequence second'])
